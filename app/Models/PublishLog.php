...
class PublishLog extends Model
{
    ...
    public $timestamps = false; // created_at داریم ولی updated_at نداریم
    ...
    public function device()
    {
        return $this->hasOneThrough(
            ...
            'id',           // Foreign key on MqttTopic for PublishLog -> mqtt_topic_id
            'id',           // Foreign key on Device for MqttTopic -> device_id
            'mqtt_topic_id',// Local key on PublishLog
